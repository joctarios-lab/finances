...
-- ---------------------------------------------------------------------------
-- Conferência: rode isto depois e verifique se aparecem 21 tabelas, todas com
...
--
-- ia_config e ia_chats são as duas únicas de escopo PESSOAL (auth.uid()), não
-- da família, e guardam conteúdo cifrado no navegador — ver o bloco delas acima.
--
-- As 19: families e family_members (a própria família), as 14 que o app
